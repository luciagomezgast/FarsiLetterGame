...
function randomNumbers(cardlength){
    let randomNumber = Math.floor(Math.random() * cardlength);
    let randomNumber2 = Math.floor(Math.random() * cardlength);
    let randomNumber3 = Math.floor(Math.random() * cardlength);

  while (randomNumber2 === randomNumber || randomNumber3 === randomNumber || randomNumber2 === randomNumber3) {
      randomNumber2 = Math.floor(Math.random() * cardlength);
      randomNumber3 = Math.floor(Math.random() * cardlength);
  } 
...
function App() {
  ...
  const [randomNumeros, setRandomNumeros]= useState(randomNumbers(card.length))

  const[orderCards, setOrderCards] = useState(shuffleArray([0,1,2]))


  const randomNumber = randomNumeros[0]
  const randomNumber2 = randomNumeros[1]
  const randomNumber3 = randomNumeros[2]
...
//turn to function the useEffect
...
const items = [randomItem,randomItem2,randomItem3]
const components= orderCards.map((index) => {
